...
-   [ggparcoord()](https://ggobi.github.io/ggally/reference/ggparcoord.html) of [GGally](https://ggobi.github.io/ggally/) package

-   [parcoords](https://cran.r-project.org/web/packages/parcoords/index.html) user guide
