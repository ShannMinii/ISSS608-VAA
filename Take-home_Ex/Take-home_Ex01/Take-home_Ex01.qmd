...
## 2.1 Consolidate individual student performance data into school-wide metrics
...
# Assuming school_avg_scores is your dataframe with 'CNTSCHID' as a categorical variable and 'AvgMathScore' as numeric
ggplot(school_avg_scores, aes(y = CNTSCHID, x = AvgMathScore)) +
  geom_bar(stat = "identity", fill = "blue") +
  theme_minimal() +
  labs(title = "Average Mathematics Scores by School", y = "School ID", x = "Average Score") +
  coord_flip() +  # This flips the coordinates to make it a horizontal bar chart
  theme(axis.text.y = element_text(angle = 0))  # Since we flipped the axes, now adjust the y-axis text
```