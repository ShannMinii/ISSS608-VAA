...
# Assuming school_avg_scores is your dataframe and CNTSCHID is a factor with many levels
ggplot(school_avg_scores, aes(x = CNTSCHID, y = AvgMathScore)) +
  geom_bar(stat = "identity", fill = "blue") +
  theme_minimal() +
  labs(title = "Average Mathematics Scores by School", x = "School ID", y = "Average Score") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  facet_wrap(~ CNTSCHID, scales = "free_x", ncol = 10)  # Adjust ncol for the number of columns you want
```