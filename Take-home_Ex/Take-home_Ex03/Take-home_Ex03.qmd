...
Data points, represented by dots, show the actual observed average mean temperatures for the months of June in the specified years. The confidence interval widens as it extends away from the data points, reflecting increasing uncertainty in predictions further away from the observed data.
